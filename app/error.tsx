...
export default function GlobalError({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 pb-4 pt-20 md:p-8 relative overflow-hidden bg-background w-full">
      ...
      <div className="absolute inset-0 pointer-events-none bg-linear-to-t from-background via-transparent to-transparent opacity-50 dark:from-background dark:via-transparent dark:to-transparent dark:opacity-60" />
