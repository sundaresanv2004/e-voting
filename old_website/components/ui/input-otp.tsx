  ...
  return (
    <OTPInput
      ...
      containerClassName={cn(
        "cn-input-otp flex items-center has-disabled:opacity-50 gap-3",
        containerClassName
      )}
      spellCheck={false}
