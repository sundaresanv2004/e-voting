...
def render_email_layout(content: str, title: str = "E-Voting") -> str:
...
<head>
  ...
  <style>
    ...
    .details-container {{ background-color: #f3f4f6; border-radius: 12px; padding: 24px; margin-bottom: 32px; border: 1px solid #e5e7eb; }}
    .detail-row {{ margin-bottom: 8px; font-size: 14px; color: #4b5563; display: flex; justify-content: space-between; }}
