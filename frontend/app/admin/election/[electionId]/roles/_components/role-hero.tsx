...
import { Archive01Icon, ShieldKeyIcon } from '@hugeicons/core-free-icons';
...
const RoleHero: React.FC<RoleHeroProps> = ({ title = "Election Roles", subtitle, children }) => {
    return (
            ...
            <div className="flex flex-col space-y-4 py-6 px-4 md:px-8 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 w-full">
                <div className="flex items-center gap-4 text-left">
                    <div className="rounded-2xl bg-primary/10 p-3.5 ring-1 ring-primary/20 shadow-sm">
                        <HugeiconsIcon icon={ShieldKeyIcon} strokeWidth={2} className="h-6 w-6 text-primary" color="currentColor" />
                    </div>
